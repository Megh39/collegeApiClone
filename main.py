...
async def allNirf(request: Request, page: int = 1, limit: int = 50):
    ...
    if output == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data for 'All NIRF listed colleges.'")
...
async def allNirf(request: Request, page: int = 1, limit: int = 50):
    ...
    if output == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data for 'All NIRF Ranked colleges.'")
...
async def allNirfByState(request: Request, state: str or None = None):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data of all NIRF listed colleges by '{state}'.")
...
async def allNirfByCity(request: Request, city: str or None = None):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data of all NIRF listed colleges by '{city}'.")
...
async def engineeringColleges(request: Request, page: int = 1, limit: int = 50):
    ...
    if output == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data for 'All Engineering colleges.'")
...
async def engineeringCollegesNirf(request: Request, page: int = 1, limit: int = 50):
    ...
    if output == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data for 'All NIRF Engineering colleges.'")
...
async def engineeringCollegesByState(request: Request, state: str or None = None, page: int = 1, limit: int = 50):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data of Engineering colleges for '{state}'.")
...
async def engineeringCollegesByCity(request: Request, city: str or None = None, page: int = 1, limit: int = 50):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data of Engineering colleges for '{city}'.")
...
async def medicalColleges(request: Request, page: int = 1, limit: int = 50):
    ...
    if output == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data for 'All Medical colleges.'")
...
async def nirfMedicalColleges(request: Request, page: int = 1, limit: int = 50):
    ...
    if output == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data for 'All NIRF Medical colleges.'")
...
async def medicalCollegesByState(request: Request, state: str or None = None, page: int = 1, limit: int = 50):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data of Medical colleges for '{state}'.")
...
async def medicalCollegesByCity(request: Request, city: str or None = None, page: int = 1, limit: int = 50):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data of Medical colleges for '{city}'.")
...
async def managementColleges(request: Request, page: int = 1, limit: int = 50):
    ...
    if output == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data for 'All Management colleges.'")
...
async def managementCollegesNirf(request: Request, page: int = 1, limit: int = 50):
    ...
    if output == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data for 'All NIRF Management colleges.'")
...
async def managementCollegesByState(request: Request, state: str or None = None, page: int = 1, limit: int = 50):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data of Management colleges for '{state}'.")
...
async def managementCollegesByCity(request: Request, city: str or None = None, page: int = 1, limit: int = 50):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data of Management colleges for '{city}'.")
...
async def collegesByState(request: Request, state: str or None = None, page: int = 1, limit: int = 50):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data of all colleges for '{state}'.")
...
async def collegesByCity(request: Request, city: str or None = None, page: int = 1, limit: int = 50):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data of all colleges for '{city}'.")
...
async def allParticipatedPharmacyCollege(request: Request, page: int = 1, limit: int = 50):
    ...
    if output == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data for 'All Pharmacy colleges.'")
...
async def pharmacyCollegesNirf(request: Request, page: int = 1, limit: int = 50):
    ...
    if output == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data for 'All NIRF Pharmacy colleges.'")
...
async def pharmacyCollegesByState(request: Request, state: str or None = None, page: int = 1, limit: int = 50):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data of Pharmacy colleges for '{state}'.")
...
async def pharmacyCollegesByCity(request: Request, city: str or None = None, page: int = 1, limit: int = 50):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data of Pharmacy colleges for '{city}'.")
...
async def participating_dental_colleges(request: Request, page: int = 1, limit: int = 50):
    ...
    if output == -1:
        raise HTTPException(
            status_code=404, detail="Unable to fetch data for 'All Dental colleges.'")
...
async def nirf_dental_colleges(request: Request, page: int = 1, limit: int = 50):
    ...
    if output == -1:
        raise HTTPException(
            status_code=404, detail="Unable to fetch data for 'All NIRF Dental colleges.'")
...
async def dentalCollegesByState(request: Request, state: str or None = None, page: int = 1, limit: int = 50):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data of Dental colleges for '{state}'.")
...
async def dentalCollegesByCity(request: Request, city: str or None = None, page: int = 1, limit: int = 50):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data of Dental colleges for '{city}'.")
...
async def nirf_law_colleges(request: Request, page: int = 1, limit: int = 50):
    ...
    if output == -1:
        raise HTTPException(
            status_code=404, detail="Unable to fetch data for 'All NIRF Law colleges.'")

    return paginate(json.loads(output), page, limit)


@app.get('/law_colleges', description='All the participated law institutes', tags=['law_colleges'])
@limiter.limit("5/minute")
async def law_colleges(request: Request, page: int = 1, limit: int = 50):
    ...
    if output == -1:
        raise HTTPException(
            status_code=404, detail="Unable to fetch data for 'All participated Law institutes.'")
...
async def dentalCollegesByState(request: Request, state: str or None = None, page: int = 1, limit: int = 50):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data of Law colleges for '{state}'.")
...
async def dentalCollegesByCity(request: Request, city: str or None = None, page: int = 1, limit: int = 50):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data of Law colleges for '{city}'.")
...
async def researchColleges(request: Request, page: int = 1, limit: int = 50):
    ...
    if output == -1:
        raise HTTPException(
            status_code=404, detail="Unable to fetch data for 'All Architecture colleges'.")
...
async def architectureCollegesNirf(request: Request, page: int = 1, limit: int = 50):
    ...
    if output == -1:
        raise HTTPException(
            status_code=404, detail="Unable to fetch data for 'All NIRF Architecture colleges'.")
...
async def architectureCollegesByState(request: Request, state: str or None = None, page: int = 1, limit: int = 50):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data of Architecture collegs for '{state}'.")
...
async def architectureCollegesByCity(request: Request, city: str or None = None, page: int = 1, limit: int = 50):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data of Architecture collegs for '{city}'.")
...
async def researchColleges(request: Request, page: int = 1, limit: int = 50):
    ...
    if output == -1:
        raise HTTPException(
            status_code=404, detail="Unable to fetch data for 'All research colleges.'")
...
async def nirfResearchColleges(request: Request, page: int = 1, limit: int = 50):
    ...
    if output == -1:
        raise HTTPException(
            status_code=404, detail="Unable to fetch data for 'All NIRF research colleges.'")
...
async def researchCollegesByState(request: Request, state: str or None = None, page: int = 1, limit: int = 50):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data of research colleges for '{state}'.")
...
async def researchCollegesByCity(request: Request, city: str or None = None, page: int = 1, limit: int = 50):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch data of research colleges for '{city}'.")
...
async def universities(request: Request, page: int = 1, limit: int = 50):
    ...
    if output == -1:
        raise HTTPException(
            status_code=404, detail="Unable to fetch data for 'All NIRF Universities.'")
...
async def universitiesbyState(request: Request, state, page: int = 1, limit: int = 50):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch Universities data for '{state}'.")
...
async def universitiesByCity(request: Request, city, page: int = 1, limit: int = 50):
    ...
    if response == -1:
        raise HTTPException(
            status_code=404, detail=f"Unable to fetch Universities data for '{city}'.")
